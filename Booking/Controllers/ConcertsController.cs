...
//using ConcertBooking.WebHost.Migrations;
using Booking.WebHost.ViewModels;
...
namespace Booking.WebHost.Controllers
{
    public class ConcertsController : Controller
    {
        ...
        {
            var astists = await _artistRepo.GetAll();
            var venues = await _venueRepo.GetAll();
            ViewBag.artistList = new SelectList(astists, "Id", "Name");
        ...
        public async Task<IActionResult> Edit(EditConcertViewModel vm)
        {
            ...
            {
                concert.ImageUrl = await _utilityRepo.EditImage(containerName,vm.ChooseImage,
                    concert.ImageUrl);
            }
